...
CREATE TABLE spring_rest_security_base.`person`(
...
CREATE TABLE spring_rest_security_base.mobile_home(
    id           int(11) NOT NULL AUTO_INCREMENT,
    brand           varchar(255),
...
CREATE TABLE spring_rest_security_base.`repair_work`(
    id            int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE spring_rest_security_base.`spare_part`(
    id              int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE spring_rest_security_base. `parts_work`(
...
CREATE TABLE spring_rest_security_base.`user_data`(
    id       int(11)     NOT NULL AUTO_INCREMENT,
...
CREATE TABLE spring_rest_security_base.`user_role`(
    id   int(11)     NOT NULL AUTO_INCREMENT,
...
CREATE TABLE spring_rest_security_base.`userdata_userrole`(
